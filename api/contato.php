...
if($email === '') $erros[] = 'O email é obrigatorio.';
elseif (!filter_var($email, FILTER_VALIDATE_EMAIL)) $erros[] = 'O e-mail é invalido.';
if (strlen($mensagem) < 10) $erros[] = 'Mensagem com mais de 10+ caracteres.';
